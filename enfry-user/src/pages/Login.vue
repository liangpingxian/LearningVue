          ...
          <el-tab-pane label="账号登录" name="first">
            <div class="loginInput">
              <el-input
                ...
                <img slot="prefix" src="../assets/userNameLogo.png" style="padding-top: 1px">
              </el-input>
            </div>
            <div class="loginInput">
              <el-input type="password" v-model="user.password" placeholder="密码">
                <img slot="prefix" src="../assets/password.png"  style="padding-top: 1px">
              </el-input>
            </div>
            <div class="loginInput checkCode">
              <el-input v-model="checkCode" placeholder="验证码" class="checkCodeElInput">
                <img slot="prefix" src="../assets/checkCode.png"  style="padding-top: 1px; height: 38px">
              </el-input>
            ...
            <div class="loginInput">
              <el-button class="submitButton" type="primary" @click="loginFunction">
                登录
              </el-button>
            </div>
          </el-tab-pane>
          <el-tab-pane label="扫码登录" name="second">
            <div class="scanState" v-if="!scanIsOK">
            <div id="scanQRCode">
              <img src="" alt="">
            </div>
